...
const AppFooter = () => {
  ...
  return (
    <footer className="px-4 divide-y font-roboto bg-gray-100 text-black">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-base gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
          <div className="space-y-3">
            <h3 className="tracking-tighter font-bold uppercase text-black">
              Services
            </h3>
            <ul className="space-y-1 underline-none text-black list-none">
              <li className="list-none">
                <Link
                  ...
                  href="/all-services#Oven Services"
                >
                  Oven Services
                </Link>
              </li>
              <li>
                <Link
                  className="text-black no-underline"
                  href="/all-services#Water Purifier Services"
                >
              ...
              <li>
                <Link
                  className="text-black no-underline"
                  href="/all-services#Generator Services"
                >
                  Generator Services
                </Link>
              </li>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              <Link
                className="text-black text-3xl no-underline"
      ...
      <div className="py-3 text-sm text-center text-gray-600">
        © {establish} ProTechFixer. All rights reserved.
      </div>
    </footer>
  );
};
